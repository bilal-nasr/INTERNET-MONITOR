...
export const ar = {
  ...
  pager: {
    ...
    previous: "السابق",
    next: "التالي",
    failed: "تعذّر تحميل هذه الصفحة: {reason}",
  },
  ...
  sessions: {
    ...
    footnote:
      "الإجماليات هي مجموع عدّادات كل جلسة على حدة، فلا تُفقد حركة البيانات ولا تُحتسب مرتين عند إعادة الاتصال. أما حركة البيانات بين آخر عيّنة وانقطاع مفاجئ فلا يمكن استرجاعها، لذا قد تقلّ قراءة الجلسة بمقدار فاصل قراءة واحد. يقرأ تقرير الانقطاعات أحدث {limit} جلسة في الفترة كحد أقصى؛ ضيّق الفترة للاطلاع على الانقطاعات الأقدم.",
  ...
  settings: {
    ...
    tabs: {
      ...
      appearance: "المظهر",
      appearanceHint: "كيف يبدو التطبيق في هذا المتصفح.",
      account: "الحساب",
    ...
    appearance: {
      card: "السمة",
      cardHint: "يُطبَّق فوراً ويُحفظ في هذا المتصفح فقط. خيار النظام يتبع إعداد الوضع الفاتح أو الداكن في جهازك.",
      system: "النظام",
      light: "فاتح",
      dark: "داكن",
    },
  ...
  share: {
    ...
    gateTitle: "جارٍ التحقق من المتصفح",
    gateHint: "تحقق سريع من أنك شخص وليس برنامجاً آلياً. يظهر الاستهلاك فور اجتيازه.",
  },
  ...
  errors: {
    ...
    captchaFailed: "لم يجتز المتصفح التحقق. انتظر حتى يكتمل ثم حاول مجدداً.",
