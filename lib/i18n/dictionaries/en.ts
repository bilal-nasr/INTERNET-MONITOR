...
export const en = {
  ...
  settings: {
    ...
    tabs: {
      ...
      appearanceHint: "How the app looks in this browser.",
      account: "Account",
    ...
    appearance: {
      card: "Theme",
      cardHint: "Applies at once and is remembered in this browser only. System follows your device's light or dark setting.",
      system: "System",
      light: "Light",
      dark: "Dark",
    },
